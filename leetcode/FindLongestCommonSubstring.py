...
"""
Given two different strings, find the length of the longest common substring between the two
"""


@leetcode_test
def find_longest_common_substring(s: str, t: str) -> int:
    m, n = len(s), len(t)
    # init 2D matrix n * m
...
@leetcode_test
def find_longest_common_substring_II(s: str, t: str) -> int:
...
find_longest_common_substring(s1, t1)
find_longest_common_substring_II(s1, t1)
